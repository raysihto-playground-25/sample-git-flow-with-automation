...
/**
 * Concrete implementation of GitHubRepository using Octokit.
 * This class handles all actual GitHub API interactions.
 */
export class OctokitGitHubRepository implements GitHubRepository {
  ...
  async fetchPullRequestCommits(owner: string, repo: string, prNumber: number): Promise<CommitInfo[]> {
