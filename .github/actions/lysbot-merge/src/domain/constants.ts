/**
 * Domain constants - Pure business rules and validation patterns
 *
 * These constants represent core business rules that are independent
 * of external infrastructure or frameworks.
 */
