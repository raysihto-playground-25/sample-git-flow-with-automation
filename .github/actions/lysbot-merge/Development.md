...
This project follows a **Lightweight Modular Monolith** architecture pattern for GitHub Actions development. For detailed information about the architecture policy, directory structure, and section contracts, see **[Architecture.md](./Architecture.md)**.
