...
import type { ActionConfig, CheckResult, EventContext, Octokit, PullRequestData } from '../src/types/index.js';
...
import { getMergeableStateDescription, validatePRState } from '../src/validation/pr-state.js';
import { hasValidAuthorAssociation, hasValidPermission, isBot } from '../src/validation/user-checks.js';
